...
FR = {
    ...
    # Releves au deuxieme passage.
    "oil & gas refining & marketing": "Raffinage et distribution",
    "oil & gas exploration & production": "Exploration pétrolière",
    "oil & gas equipment & services": "Services pétroliers",
    "oil & gas drilling": "Forage pétrolier",
    "real estate - development": "Promotion immobilière",
    "residential construction": "Construction résidentielle",
    "consumer discretionary": "Consommation cyclique",
    "consumer staples": "Consommation de base",
    "financials": "Services financiers",
    "financial conglomerates": "Conglomérat financier",
    "reit - retail": "Foncière commerce",
    "reit - residential": "Foncière résidentielle",
    "reit - industrial": "Foncière logistique",
    "reit - office": "Foncière bureaux",
    "reit - healthcare facilities": "Foncière santé",
    "reit - hotel & motel": "Foncière hôtelière",
    "reit - specialty": "Foncière spécialisée",
    "airports & air services": "Aéroports",
    "electronics & computer distribution": "Distribution informatique",
    "communication equipment": "Équipement télécom",
    "computer hardware": "Matériel informatique",
    "thermal coal": "Charbon thermique", "coking coal": "Charbon métallurgique",
    "silver": "Mines d'argent", "lumber & wood production": "Bois",
    "textile manufacturing": "Textile",
    "recreational vehicles": "Véhicules de loisirs",
    "tools & accessories": "Outillage",
    "health information services": "Santé numérique",
    "insurance brokers": "Courtage d'assurance",
    "banks": "Banque", "shell companies ": "Coquille",
}
